...
class AlphaBeteVsMinimax {
  def init(): Unit = {
    ...
    val numberOfGame = 5
    val testData = List(
      new TestData(4, miniMaxVisitor, miniMaxVisitor, numberOfGame),
      new TestData(5, miniMaxVisitor, miniMaxVisitor, numberOfGame),
      new TestData(6, miniMaxVisitor, miniMaxVisitor, numberOfGame),
      new TestData(7, miniMaxVisitor, miniMaxVisitor, numberOfGame),
      new TestData(8, miniMaxVisitor, miniMaxVisitor, numberOfGame),
      new TestData(9, miniMaxVisitor, miniMaxVisitor, numberOfGame),
      new TestData(10, miniMaxVisitor, miniMaxVisitor, numberOfGame),
    )
